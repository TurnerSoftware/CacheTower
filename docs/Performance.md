...
|                  Method |       Mean [ns] |   Error [ns] |    StdDev [ns] | Gen 0 | Gen 1 | Gen 2 | Allocated [B] |
|------------------------ |----------------:|-------------:|---------------:|------:|------:|------:|--------------:|
|      GetHitSimultaneous |  2,189,141.6 ns |  77,993.1 ns |   321,610.1 ns |     - |     - |     - |       12056 B |
| SetExistingSimultaneous |  2,371,159.4 ns |  84,328.8 ns |   349,619.0 ns |     - |     - |     - |       12304 B |
|                Overhead |  1,104,563.5 ns |  44,495.4 ns |   186,934.9 ns |     - |     - |     - |        4480 B |
|                 GetMiss |  1,517,239.6 ns |  58,884.1 ns |   244,782.5 ns |     - |     - |     - |        7096 B |
|                  GetHit |  2,058,590.8 ns |  82,617.7 ns |   346,185.9 ns |     - |     - |     - |       11032 B |
|                  SetNew |  1,919,392.6 ns |  70,859.3 ns |   291,398.9 ns |     - |     - |     - |        9472 B |
|             SetExisting |  2,136,628.6 ns |  71,480.9 ns |   296,352.8 ns |     - |     - |     - |       11384 B |
|                 SetMany | 40,971,128.8 ns | 815,686.6 ns | 3,037,180.1 ns |     - |     - |     - |      259320 B |
