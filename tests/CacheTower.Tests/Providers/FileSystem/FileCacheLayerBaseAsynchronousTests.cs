...
{
	[TestClass]
	public class FileCacheLayerBaseAsynchronousTests : TestBase
	{
		...
		{
			using var cacheLayer = new TestFileCacheLayer(DirectoryPath, null);
		...
		{
			using var cacheLayer = new TestFileCacheLayer(DirectoryPath, ".mycustomfileextension");
